...
Tu identificador: **site1**. Tus modelos: **gemma2:9b, qwen2.5:7b, deepseek-v2:16b**.
...
3. Identifica tu sitio de forma permanente:
   `echo 'export NORMDRIFT_SITE=site1' >> ~/.zshrc && export NORMDRIFT_SITE=site1`
...
Modelo gemma2:9b (tu session_idx: 0):
`caffeinate -i python3 normdrift.py run --condition C0  --model gemma2:9b --session 0`
`caffeinate -i python3 normdrift.py run --condition C1  --model gemma2:9b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2  --model gemma2:9b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2p --model gemma2:9b --session 0`
Modelo qwen2.5:7b (tu session_idx: 0):
`caffeinate -i python3 normdrift.py run --condition C0  --model qwen2.5:7b --session 0`
`caffeinate -i python3 normdrift.py run --condition C1  --model qwen2.5:7b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2  --model qwen2.5:7b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2p --model qwen2.5:7b --session 0`
Modelo deepseek-v2:16b (tu session_idx: 0):
`caffeinate -i python3 normdrift.py run --condition C0  --model deepseek-v2:16b --session 0`
`caffeinate -i python3 normdrift.py run --condition C1  --model deepseek-v2:16b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2  --model deepseek-v2:16b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2p --model deepseek-v2:16b --session 0`
...
`git checkout -b resultados-site1`
`git add results/ && git commit -m "resultados site1" && git push -u origin resultados-site1`
