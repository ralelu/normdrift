...
Tu identificador: **site3**. Tus modelos: **gemma3:latest, phi4, llama3:8b**.
...
3. Identifica tu sitio de forma permanente:
   `echo 'export NORMDRIFT_SITE=site3' >> ~/.zshrc && export NORMDRIFT_SITE=site3`
...
Modelo gemma3:latest (tu session_idx: 0):
`caffeinate -i python3 normdrift.py run --condition C0  --model gemma3:latest --session 0`
`caffeinate -i python3 normdrift.py run --condition C1  --model gemma3:latest --session 0`
`caffeinate -i python3 normdrift.py run --condition C2  --model gemma3:latest --session 0`
`caffeinate -i python3 normdrift.py run --condition C2p --model gemma3:latest --session 0`
Modelo phi4 (tu session_idx: 1):
`caffeinate -i python3 normdrift.py run --condition C0  --model phi4 --session 1`
`caffeinate -i python3 normdrift.py run --condition C1  --model phi4 --session 1`
`caffeinate -i python3 normdrift.py run --condition C2  --model phi4 --session 1`
`caffeinate -i python3 normdrift.py run --condition C2p --model phi4 --session 1`
Modelo llama3:8b (tu session_idx: 0):
`caffeinate -i python3 normdrift.py run --condition C0  --model llama3:8b --session 0`
`caffeinate -i python3 normdrift.py run --condition C1  --model llama3:8b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2  --model llama3:8b --session 0`
`caffeinate -i python3 normdrift.py run --condition C2p --model llama3:8b --session 0`
...
`git checkout -b resultados-site3`
`git add results/ && git commit -m "resultados site3" && git push -u origin resultados-site3`
